"""Shared synchronisation quality metrics for IMU streams.

This module centralises computation of simple correlation-based metrics used
by all four sync methods — :mod:`sync.sda_sync`, :mod:`sync.lida_sync`,
:mod:`sync.calibration_sync`, and :mod:`sync.online_sync`. Keeping the logic
here ensures that ``sync_info.json`` files are consistent across methods,
which simplifies downstream comparison in :mod:`sync.selection`.
"""
...
from .drift_estimator import SyncModel, apply_sync_model
