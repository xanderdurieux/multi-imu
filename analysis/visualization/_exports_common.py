...
META_COLS = frozenset({
    ...
    "window_end_ms",
    "window_duration_s",
    # Raw multi-label set persisted by features.csv. Resolved label columns are
    # derived on demand by ensure_resolved_labels and are also excluded from
    # feature columns by virtue of being non-numeric.
    "scenario_labels",
    "scenario_label",
