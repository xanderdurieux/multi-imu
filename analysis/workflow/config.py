...
class WorkflowConfig:
    ...
    frame_alignment: str = "gravity_only"            # "gravity_only"|"gravity_plus_forward"
    orientation_filter: str = "madgwick"             # "madgwick"|"complementary"
